...
CREATE TABLE `evaluate` (
  ...
  `evaluateme` varchar(45) NOT NULL,
  `evaluatepr` varchar(45) NOT NULL,
  `evaluatecnu` varchar(45) NOT NULL,
...
CREATE TABLE `greens` (
  ...
  `greenstype` varchar(45) NOT NULL,
...
CREATE TABLE `jurisdiction` (
  ...
  `jurisdictiontype` varchar(45) NOT NULL,
  `jurisdictioncol` varchar(45) NOT NULL,
...
--
-- Table structure for table `rownumer`
--

DROP TABLE IF EXISTS `rownumer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rownumer` (
  `rownumerid` int(11) NOT NULL,
  `rownumeror` varchar(45) NOT NULL,
  `rownumertime` varchar(45) NOT NULL,
  PRIMARY KEY (`rownumerid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rownumer`
--

LOCK TABLES `rownumer` WRITE;
/*!40000 ALTER TABLE `rownumer` DISABLE KEYS */;
/*!40000 ALTER TABLE `rownumer` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `table1` (
  ...
  `table1number` varchar(45) NOT NULL,
...
--
-- Dumping routines for database 'canting'
--
...
-- Dump completed on 2016-11-28 17:43:56
